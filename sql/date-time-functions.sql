...
SELECT
    ...
    EXTRACT(TIMEZONE_HOUR FROM CURRENT_TIMESTAMP) tz_hour,
    EXTRACT(TIMEZONE_MINUTE FROM CURRENT_TIMESTAMP) tz_minute,
    EXTRACT(TIMEZONE_REGION FROM CURRENT_TIMESTAMP) tz_region,
    EXTRACT(TIMEZONE_ABBR FROM CURRENT_TIMESTAMP) tz_abbr
FROM dual;
